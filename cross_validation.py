...
def leave_one_group_out_cross_validation(df, Group_set, group_name, hyperparameters, primer_df, GPT2FR):
...
if __name__ == "__main__":
    ...
    df = leave_one_group_out_cross_validation(df, Types,  "Type",  hyperparameters, primer_df, GPT2FR)
    #df = leave_one_group_out_cross_validation(df, Topics, "Topic", hyperparameters, primer_df, GPT2FR)
